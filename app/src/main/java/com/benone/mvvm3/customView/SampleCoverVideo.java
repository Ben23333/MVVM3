...
import com.benone.mvvm3.utils.Utils;
...
public class SampleCoverVideo extends StandardGSYVideoPlayer {
    ...
    protected void init(Context context) {
        ...
        mFullscreenButton.setPadding(Utils.dip2px(context, 10), Utils.dip2px(context, 10), Utils.dip2px(context, 10), Utils.dip2px(context, 10));
